...
class Profile extends React.Component {
  ...
  checkFollow = (auth, user) => {
    return user.followers.findIndex(follower => {
      (follower._id === auth.user._id) > -1 // findIndex returns -1 if no follower was found
    })
  }
  ...
  render() {
    ...
    const { isLoading, user, isAuth, checkFollow, isFollowing } = this.state;
    return (
          ...
          <div className={classes.progressContainer}>
            ...
            <List dense>
              <ListItem>
                ...
                {/* Auth - Edit Buttons || UnAuth - Follow/Unfollow Buttons */}
                {isAuth ? (
